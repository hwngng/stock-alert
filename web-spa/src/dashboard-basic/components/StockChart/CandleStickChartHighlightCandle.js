				...
				>
					...
					{/* <HoverTooltip
						...
						tooltipContent={this.tooltipContent([
							{
								label: `${sma10.type()}(${sma10.options()
									.windowSize})`,
								value: d => numberFormat(sma10.accessor()(d)),
								stroke: sma10.stroke()
							},
							{
								label: `${sma45.type()}(${sma45.options()
									.windowSize})`,
								value: d => numberFormat(sma45.accessor()(d)),
								stroke: sma45.stroke()
							}
						])}
						fontSize={15}
